...
public class CheckSubscriberValidTestCase extends XMLTestCase {
    ...
    public void testRechargeSubscriber() throws Exception {
    	requestData = new FileInputStream(requestPath + "CheckSubscriberValidRequest.xml");
        ...
        System.out.println("CheckSubscriberValidResponse:");

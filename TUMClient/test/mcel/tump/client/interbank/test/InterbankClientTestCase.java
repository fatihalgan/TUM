package mcel.tump.client.interbank.test;
...
public class InterbankClientTestCase extends XMLTestCase {
    ...
    public void setUp() throws Exception {
        ctx = new FileSystemXmlApplicationContext("D:/RHDSWorkspaces/MCel/TUMP/TUMClient/test/mcel/tump/client/interbank/test/applicationContext.xml");
        xmlRpcClient = (IXMLRPCClient)ctx.getBean("xmlRpcClient");
        requestPath = "D:/RHDSWorkspaces/MCel/TUMP/TUMClient/test/mcel/tump/client/interbank/test/";
    ...
    public void testChangePassword() throws Exception {
    	requestData = new FileInputStream(requestPath + "ChangePasswordRequest.xml");
    	XMLRPCMessage msg = (XMLRPCMessage)new Serializer(requestData).parse();
    	String response = xmlRpcClient.sendMessage(msg.toXML(new StringBuffer()));
        System.out.println("RechargeSubscriberResponse:");
        System.out.println(response);
    ...
    **/
    ...
    /**
    public void testCommitReservation() throws Exception {
    	requestData = new FileInputStream(requestPath + "CommitReservationRequest.xml");
    	XMLRPCMessage msg = (XMLRPCMessage)new Serializer(requestData).parse();
    	String response = xmlRpcClient.sendMessage(msg.toXML(new StringBuffer()));
        System.out.println("CommitReservationResponse:");
        System.out.println(response);
        MethodResponse result = (MethodResponse)new Serializer(response).parse();
        assertFalse(result.isFault());
    }
    **/
    ...
    /**
    public void testReserveRechargeSubscriber() throws Exception {
    	requestData = new FileInputStream(requestPath + "ReserveRechargeSubscriberRequest.xml");
    	XMLRPCMessage msg = (XMLRPCMessage)new Serializer(requestData).parse();
    	String response = xmlRpcClient.sendMessage(msg.toXML(new StringBuffer()));
        System.out.println("ReserveRechargeSubscriberResponse:");
        System.out.println(response);
        MethodResponse result = (MethodResponse)new Serializer(response).parse();
        assertFalse(result.isFault());
    }
    **/
    ...
    public void testCancelReservation() throws Exception {
    	requestData = new FileInputStream(requestPath + "CancelReservationRequest.xml");
    	XMLRPCMessage msg = (XMLRPCMessage)new Serializer(requestData).parse();
    	String response = xmlRpcClient.sendMessage(msg.toXML(new StringBuffer()));
    	System.out.print("CancelReservationResponse:");
    	System.out.println(response);
    	MethodResponse result = (MethodResponse)new Serializer(response).parse();
    	assertFalse(result.isFault());
    }

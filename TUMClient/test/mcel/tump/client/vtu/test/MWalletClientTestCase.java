...
public class MWalletClientTestCase extends XMLTestCase {
    ...
    public void setUp() throws Exception {
        ctx = new FileSystemXmlApplicationContext("D:/RHDSWorkspaces/MCel/TUMP/TUMClient/test/mcel/tump/client/vtu/test/mwallet_applicationContext.xml");
    ...
    public void testRechargeSubscriber() throws Exception {
        requestData = new FileInputStream(requestPath + "mwalletTopupRequest.xml");

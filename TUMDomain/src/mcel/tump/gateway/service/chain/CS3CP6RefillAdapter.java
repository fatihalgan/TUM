 ...
 * @author db2admin
 */
public class CS3CP6RefillAdapter implements CSCommandAdapter {
    ...
    public CS3CP6RefillAdapter(CommandFactory factory, TUMRechargeRequest request, TUMRechargeResponse response) {
    ...
    public void execute() {
        ...
        try {
            logger.debug("Sending Free Amount Refill Request to Charging System for transaction " + request.getRequestTransactionID());
            cmd.execute();
            ...
            logger.error("Could not connect to Charging System: " + e.getMessage() + " for transaction " + request.getRequestTransactionID());
            ...
            logger.error("Bad XML Format in message to Charging System: " + e.getMessage() + " for transaction " + request.getRequestTransactionID());
        	...
        	logger.error("Error in sending request message to Charging System: " + e.getMessage() + " for transaction " + request.getRequestTransactionID());

 ...
 * @author db2admin
 */
public class GetVoucherHistoryCommand extends AbstractVSCommand {

    private String serialNumber;
    private float decimalDenominator;
    
    GetVoucherHistoryCommand(String serialNumber, float decimalDenominator) {
        this.serialNumber = serialNumber;
        this.decimalDenominator = decimalDenominator;
    }
    
    public void prepareRequest() {
        request.setMethodName(VSTokens.GetVoucherHistoryMethodCallName.toString());

...
public class UpdateBalanceAndDateWithFreeCallsCommand extends AbstractCS3CP6Command {
    ...
    private Float freeCalls;
    private Float decimalDenominator;

    UpdateBalanceAndDateWithFreeCallsCommand(String originTransactionId, Date originTimestamp, String subscriberNumber,
    ...
    public void prepareRequest() {
        ...
        Float fc = (float)(getFreeCalls() * getDecimalDenominator());
        ...
        if(fc != 0) {
        	Struct da7 = new Struct();
        	da7.addMember(new Member(CSTokens.DedicatedAccountID.toString(), 7));
        	da7.addMember(new Member(CS3CP6Tokens.AdjustmentAmountRelative.toString(), String.valueOf(fc.intValue())));
        	dedicatedAccount.addStruct(da7);
        }
        if(sms != 0 || mms != 0 || fc != 0) request.addMember(new Member(CS3CP6Tokens.DedicatedAccountUpdateInformation.toString(), dedicatedAccount));
    }

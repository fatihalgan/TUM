 ...
 * @author db2admin
 */
public class StandartVoucherRefillTCommand extends AbstractCS3CP1Command {
    ...
    protected StandartVoucherRefillTCommand(String originTransactionId, Date originTimestamp, String subscriberNumber,
    ...
    public void prepareRequest() {
        request.setMethodName(CS3CP1Tokens.StandartVoucherRefillMethodCallName.toString());

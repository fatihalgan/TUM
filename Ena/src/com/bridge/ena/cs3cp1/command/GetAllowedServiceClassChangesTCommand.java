 ...
 * @author db2admin
 */
public class GetAllowedServiceClassChangesTCommand extends AbstractCS3CP1Command {
    ...
    GetAllowedServiceClassChangesTCommand(String originTransactionId, Date originTimestamp, String subscriberNumber,
    ...
    public void prepareRequest() {
        request.setMethodName(CS3CP1Tokens.GetAllowedServiceClassChangesMethodCallName.toString());

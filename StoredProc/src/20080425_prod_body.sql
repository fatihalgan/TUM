...
AND PROCESSED = 0;
  ...
  LOOP
    ...
    WHERE ID = P_TRAN_CURSOR.EXTERNALDATA2;
             ...
             INSERT INTO TUM_YOYOBASE_TBL COLUMNS(RECON_ID,DATEOF,MSISDN,AMOUNT,PROCESSED)
             VALUES(V_RECON_ID,V_RECON_SCOPE,P_TRAN_CURSOR.ACCOUNT_NUMBER,P_TRAN_CURSOR.TRANSACTION_AMOUNT,0);
...
INSERT INTO TUM_RECON_PER_DLR_USER_SUM_TBL (RECON_ID,TUM_DEALER_ID,USERNAME,NUM_TRAN,AMOUNT_TRAN)
